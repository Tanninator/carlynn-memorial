...
`;
  ...
  const LW_LABELS = {
    ...
    zh: {
      from: "来自", namePh: "您的名字",
      relLabel: "您与卡小粒的关系", optional: "（选填）",
      relPh: "例如：叔叔 · 阿姨 · 家庭好友",
      msgLabel: "您的留言",
      msgPh: "一段回忆、一句感谢、一声道别。想写多长都可以。",
      photos: "照片", upTo: (n) => `（最多 ${n} 张，选填）`,
      light: "点一盏点亮心灯", sending: "提交中…",
      lanternsLit: (n) => `已点亮 ${n} 盏点亮心灯`,
      newest: "最新", oldest: "最早",
      stamp: "写给卡小粒的话",
      gateTitle: "家人密码",
      gateBody: "此墙仅供家人与挚友使用。请输入您收到的密码以点亮一盏点亮心灯。",
      passwordPh: "密码", cancel: "取消", continue: "继续",
      prev: "上一个", next: "下一个", prevPhoto: "上一张照片", nextPhoto: "下一张照片",
      loading: "加载中…", beFirst: "成为第一个点亮点亮心灯的人。",
